        ...
        <section className='first-section-index'>
          ...
          <section className='section-3'>
            ...
            <div className='card-1'>
                <CardComponent name='JAVA, React, Angular, Springboot ,etc..' role='JAVA Full Stack Developer' text="aljskndlcad" link="/java"/>
                <CardComponent name='PHP, HTML, CSS, JavaScript,Vue.js' role='LAMP Stack Developer' text="aljskndlcad" link="/java" />
                <CardComponent name='MongoDB, Express.js, Angular, Node.js' role ='MEAN Stack Developer' text="aljskndlcad" link="/java" />
            </div>
            <div className='card-2'>
                <CardComponent name='PYTHON' role='PYTHON Full Stack Developer' text="aljskndlcad" link="/java" />
                <CardComponent name='#' role='Full Stack Developer' />
                <CardComponent name='PHP, HTML, CSS, JavaScript, React or Angular' role ='PHP Stack Developer' text="aljskndlcad" link="/java" />
            </div>
            <div className='card-3'>
                <CardComponent name='C#, Blazor, Angular, React, ASP.NET Core' role='C# Full Stack Developer' text="aljskndlcad" link="/java"/>
                <CardComponent name='MongoDB, Express.js, React, Node.js' role='MERN Stack Developer' text="aljskndlcad" link="/java"/>
                <CardComponent name='ASP.NET Core, Blazor, Angular, React ,C#' role ='ASP.NET Stack Developer' text="aljskndlcad" link="/java" />
            </div>
            </div>
          </section>
...
// import MorphingBackground from '../ProfileComp';
// import WaveCard from '../CardComp/WaveCard';
...
//         <section className='section-3'>
//           <div className='card-1'>
//               <WaveCard name='Java' role='Java Full Stack Developer'
//               image='https://res.cloudinary.com/dcneemn9t/image/upload/v1715937608/java_icon_n1blpd.png'
              
//               />

//               <WaveCard name='Lamp' role='Lamp Stack Developer'  image='https://res.cloudinary.com/dcneemn9t/image/upload/v1715937608/java_icon_n1blpd.png'/>
//               <WaveCard name='Mean' role ='Mean Stack Developer'   image='https://res.cloudinary.com/dcneemn9t/image/upload/v1715937608/java_icon_n1blpd.png'/>
//             </div>
